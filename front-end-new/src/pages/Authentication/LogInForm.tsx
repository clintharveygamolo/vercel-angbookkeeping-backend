          ...
          <form>
            ...
            <div className="relative mb-6">
              <input
                ...
                placeholder="User ID"
                required
                className="w-full h-12 pl-5 pr-16 rounded-full bg-transparent border-2 border-gray-400 text-white placeholder-white focus:outline-none"
              />
            ...
            <button
              type="submit"
              onClick={onSubmit}
              className="w-full h-12 bg-white text-black font-bold rounded-full shadow-md hover:bg-gray-100"
            >
              Login
            </button>
          </form>
