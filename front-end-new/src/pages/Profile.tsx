...
const Profile = () => {
  ...
  const createUserAccount = async (e: { preventDefault: () => void; }) => {
        e.preventDefault();
        try {
            const response = await axiosConfig.post('/api/createUser', {
                    ...
                    <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <TextInput
                          ...
                          placeholder="Name"
                          onChange={(e: any) => setUserNameFormValue(e.target.value)}
                          required
                        />
                      </div>
                      <div>
                        ...
                        <TextInput ref={userInputRefInputRef} id="password" value={userPasswordFormValue} onChange={(e: any) => setUserPasswordFormValue(e.target.value)} type="password" required />
                      </div>
                      <div>
                        <div className="w-full">
                          ...
                          <SelectGroupTwo selectedRole={selectedRole} onRoleChange={handleRoleChange} />
                        </div>
                      </div>
                      <div className="w-full">
                      ...
                      <div className="flex justify-end gap-3">
                        ...
                        <button onClick={createUserAccount} className="flex justify-center rounded bg-primary p-3 font-small text-gray hover:bg-opacity-90">
