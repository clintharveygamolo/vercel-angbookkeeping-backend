        ...
        <div className="overflow-x-auto rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
                <div className="flex justify-between items-center">
                    ...
                    <Button className="bg-primary text-white rounded-lg px-4 py-2 hover:bg-primary-dark hover:bg-opacity-90" onClick={() => setOpenModal(true)}>Add Company</Button>
                </div>
                <Modal
                    show={openModal}
                    size="md"
                        ...
                        <div className="w-full max-w-md mx-auto bg-white rounded-lg border shadow-md sm:p-2 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <Modal.Body>
                                <div className="space-y-2">
                                    <h3 className="text-xl font-medium text-gray-900 dark:text-white">Add Company</h3>
                                    <div>
                                        <div className="mb-2 block">
                                            <Label htmlFor="Company" value="Company" />
                                        </div>
                                        <TextInput id="Company" ref={userInputRefInputRef} placeholder="Bank" required />
                                    </div>
